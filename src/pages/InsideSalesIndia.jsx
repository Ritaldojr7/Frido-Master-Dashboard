...
import { insideSalesIndiaData, ICONS } from '../config/dashboardData';
import SectionGroup from '../components/SectionGroup/SectionGroup';
import './SubPage.css';

export default function InsideSalesIndia() {
    const navigate = useNavigate();
    const data = insideSalesIndiaData;
        ...
        <div className="subpage">
            ...
            <div className="subpage__header animate-fade-in-up">
                ...
                <p className="subpage__subtitle">
                    Tools, CRMs, IVR systems, references, and analytics for the India sales team
                </p>
            </div>
