    ...
    return (
        <div className="dashboard">
            ...
            <footer className="dashboard__footer">
                <a href="https://www.myfrido.com" target="_blank" rel="noopener noreferrer" className="dashboard__footer-link">
                    www.myfrido.com
                </a>
                <div className="dashboard__footer-socials">
                    <a href="https://x.com/myfrido" target="_blank" rel="noopener noreferrer" aria-label="X" className="dashboard__social-icon">
                        <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/myfrido/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="dashboard__social-icon">
                        <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                    ...
                    <a href="https://www.linkedin.com/company/myfrido/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="dashboard__social-icon">
                        <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
