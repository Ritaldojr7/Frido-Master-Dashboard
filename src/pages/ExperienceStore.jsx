...
import { experienceStoreData, ICONS } from '../config/dashboardData';
import SectionGroup from '../components/SectionGroup/SectionGroup';
import './SubPage.css';

export default function ExperienceStore() {
    const navigate = useNavigate();
    const data = experienceStoreData;
        ...
        <div className="subpage">
            <div className="subpage__header animate-fade-in-up">
                ...
                <p className="subpage__subtitle">
                    POS systems, CRM logins, product resources, and analytics for the Experience Store team
                </p>
            </div>
