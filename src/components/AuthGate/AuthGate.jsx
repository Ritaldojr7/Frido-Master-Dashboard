                    ...
                    <div className="login__form-panel">
                        <div className="login__form-container">
                            ...
                            {!showRequestForm ? (
                                <>
                                    ...
                                    <div className="login__clerk-buttons">
                                        <button id="login-submit" type="button" className="login__submit" onClick={login}>
                            ...
                            <div className="login__form-footer">
                                <p>Need help?{' '}<a href={`mailto:${getSupportContactEmail()}`} className="login__link">Contact Admin</a></p>
                            </div>
                        </div>
                    </div>
                </div>
